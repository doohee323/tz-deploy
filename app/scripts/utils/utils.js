...
function gf_SetCookie(name, value, day) {
	...
	if (day !== undefined && day !== null && day !== '') {
		expires.setDate(expires.getDate() + day); // 30'days
	} else {
 ...
 */
function gf_GetPoppyFrame(doc, objCnt, src) {
	var aObjCnt = '';
	if (objCnt)
		aObjCnt = objCnt;
	...
	doc.getElementById("poppy").innerHTML = "<iframe id='poppyFrame" + aObjCnt + "' name='poppyFrame" + aObjCnt
			+ "' src='" + src
			+ "' style='width:1000;height:1000;border:0;frameborder:0;padding:0;margin:0' scrolling=no></iframe>";
 ...
 */
function gf_GetGeoLocationInfo(callback) {
...
var gf_GetUniqueNumber = function(id) {
	var uniqueNumber = "";
	var numberGroup = [ [ "a", "b", "S", "T", "0", "1" ], [ "c", "d", "Q", "R", "2", "3" ],
			[ "e", "f", "O", "P", "4", "5" ], [ "g", "h", "M", "N", "6", "7" ], [ "i", "j", "K", "L", "8", "9" ],
			[ "k", "l", "I", "J", "U", "V" ], [ "m", "n", "G", "H", "W", "X" ], [ "o", "p", "E", "F", "Y", "u" ],
